...
?>
<div class="container">
 <button class="btn btn-primary my-5"><a href="inscription.php" class="text-light">Ajouter Reservation</a></button>
 <table class="table">
    <thead>
        <tr>
            <th scope="col">no</th>
      ...
      <?php
       ...
       if($result && $resultat ){
        while($row=mysqli_fetch_assoc($result) AND $rows=mysqli_fetch_assoc($resultat)){
            ...
            <td>
            <button class="btn btn-primary"><a href="modifier2.php?modifieid='.$id.'" class="text-light">Modifier</a></button>
            <button class="btn btn-danger"><a href="supprimer2.php?supprimeid='.$id.'" class="text-light">Supprimer</a></button>
            </td>
        </tr>'; 
        }
       }
